...
export default function ConfirmacaoPage() {
    ...
    const handleConfirm = async () => {
        ...
        try {
            ...
            if (prioridade.nivel === 1) tipoPrioridadeSenha = 'superprioridade';
            else if (prioridade.nivel === 2) tipoPrioridadeSenha = 'prioritario';
            else tipoPrioridadeSenha = 'comum';
            ...
            dispatch({
                type: 'ADD_TO_FILA',
                payload: { consulta, prioridade, senha: senhaGerada }
            });
            ...
            if (!resultadoImpressao.sucesso) {
                router.push("/totem/falha-impressao");
                return;
            }
            ...
            toast.error("Erro ao gerar senha", { description: "Tente novamente ou procure o atendente." });
        } finally {
            ...
            <main className="flex-1 flex items-center justify-center p-[0.5vw] overflow-hidden">
                <Card className="w-[96vw] h-[81vh] flex flex-col justify-between p-[2vw] shadow-xl">
                    <div className="text-center mb-[2vh]">
                        <h1 className="text-[5vw] font-black mb-[1vh] text-foreground leading-tight uppercase">
                    ...
                    <div className="flex-1 flex flex-col justify-center gap-[2vh]">
                        <Card className="w-full p-[2vw] bg-muted/50 border-4 rounded-2xl shadow-inner">
                            <div className="flex flex-col gap-[1vh]">
                                <div className="flex-1 space-y-[2vh] text-[3.5vw] leading-tight p-[1vw]">
                                    <div className="break-words">
                                        ...
                                        <span className="font-bold text-foreground text-[4vw] uppercase">{consulta.paciente.nome}</span>
                                    </div>

                                    <div className="grid grid-cols-2 gap-4">
                                        <div>
                                            <span className="text-[2.2vw] font-black uppercase text-muted-foreground block">DATA E HORA</span>
                                            <span className="font-bold text-foreground uppercase">Hoje às {consulta.hora}</span>
                                        </div>
                                        <div className="break-words">
                                    ...
                                    <div className="break-words">
                                        ...
                                        <div className="flex flex-col">
                                            <span className="font-bold text-foreground uppercase">{consulta.medico.especialidade}</span>
                            ...
                            <div className={`text-center p-[3vh] rounded-[2rem] border-[6px] shadow-lg ${lineColors.bg} ${lineColors.border} mt-[2vh]`}>
                                ...
                                <div className={`font-black ${lineColors.text} text-[6vw] leading-none tracking-tighter uppercase`}>
                                    SIGA A: {lineName}
                                </div>
                    ...
                    <div className="mt-[2vh]">
                        <div className="flex flex-row gap-[2vw] mb-[2vh]">
                            <Button
                                ...
                                className="flex-1 h-[12vh] text-[3.5vw] font-black border-4 shadow-lg bg-destructive/10 hover:bg-destructive hover:text-destructive-foreground rounded-2xl uppercase"
                            >
                                Voltar
                            </Button>
                            <Button
                            ...
                            >
                                {isGenerating ? (
                                    <div className="flex flex-col items-center">
                                        ...
                                        <span className="text-[2.5vw] leading-tight uppercase">Gerando...</span>
                                    </div>
                                ) : (
                                    <div className="text-center leading-tight">
                                        <div className="text-[3.5vw] uppercase">Confirmar</div>
                                    </div>
                                )}
                            </Button>
                        </div>
