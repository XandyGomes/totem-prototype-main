...
export default function PrioridadePage() {
    ...
    const handlePrioritario = () => {
        ...
        router.push("/totem/selecionar-prioridade");
    };
        ...
        <div className="min-h-screen flex flex-col bg-background">
            ...
            <main className="flex-1 flex items-center justify-center p-[0.5vw] overflow-hidden">
                <Card className="w-[96vw] h-[76vh] flex flex-col justify-between p-[2vw] shadow-xl relative">
                    ...
                    <Dialog open={showHelp} onOpenChange={setShowHelp}>
                        <DialogTrigger asChild>
                            <Button
                                variant="outline"
                                size="sm"
                                className="absolute top-4 right-4 w-[8vw] h-[8vw] rounded-full border-4 bg-blue-200 hover:bg-blue-300 text-blue-800 border-blue-500 animate-pulse z-10 shadow-xl flex items-center justify-center"
                            >
                                <img
                                    src="/informacao.png"
                                    alt="Informações"
                        ...
                        <DialogContent className="w-[95vw] max-w-none h-[90vh] flex flex-col p-[3vw]">
                            ...
                            <DialogDescription className="flex-1 overflow-y-auto" asChild>
                    ...
                    <div className="text-center flex-none mt-[1vh] px-[10vw]">
                        <h1 className="text-[6vw] font-black mb-[1vh] text-foreground uppercase">
                    ...
                    <div className="flex-1 flex flex-col justify-center gap-[2vh] min-h-0">
                        ...
                        >
                            <span className="text-white uppercase">Não sou preferencial</span>
                        </Button>
                    </div>
