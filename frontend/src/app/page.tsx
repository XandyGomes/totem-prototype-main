...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-[#0f172a] p-4 sm:p-8 flex flex-col items-center justify-center font-sans overflow-x-hidden relative">
      {/* Background Decor */}
      ...
      <div className="max-w-6xl w-full space-y-8 sm:space-y-12 py-8 z-10">
          ...
          {profiles.map((profile, index) => (
            ...
            >
              ...
              <CardContent className="p-6 sm:p-10 flex flex-col sm:flex-row gap-6 sm:gap-8 items-center sm:items-start text-center sm:text-left">
                <div className={`${profile.color} p-4 sm:p-6 rounded-2xl sm:rounded-3xl shadow-xl group-hover:scale-110 transition-transform duration-500 flex-shrink-0`}>
                ...
                <div className="flex-1 space-y-2 sm:space-y-3">
                  ...
                  <Button variant="ghost" className="p-0 text-blue-400 font-black uppercase text-xs sm:text-sm tracking-widest gap-2 group-hover:translate-x-2 transition-transform h-auto hover:bg-transparent">
